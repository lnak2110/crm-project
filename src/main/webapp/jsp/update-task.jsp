      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-md-8 col-xs-12">
            <div class="white-box">
              <form class="form-horizontal form-material update-task-form"
                action='<c:url value="/api/tasks">
                <c:param name = "id" value = "${param.id}"/>
                </c:url>'>
                <div class="form-group">
                  <label class="col-md-12">In project</label>
                  <div class="col-md-12">
                    <input type="text" placeholder="Project ID - Project name"
                      value="${task.project.id} - ${task.project.name}"
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-12">
                    <input type="text" placeholder="Mô tả" name="description"
                      value="${task.description}" class="form-control form-control-line">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-12">
                    <input type="date" placeholder="dd/MM/yyyy" name="startDate" id="startDate"
                      value='<c:if test="${task.startDate != null}"><fmt:formatDate 
                      value="${task.startDate}" pattern="yyyy-MM-dd" /></c:if>'
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-12">
                    <input type="date" placeholder="dd/MM/yyyy" name="endDate" id="endDate"
                      value='<c:if test="${task.endDate != null}"><fmt:formatDate
                      value="${task.endDate}" pattern="yyyy-MM-dd" /></c:if>'
                      class="form-control form-control-line">
                  </div>
                </div>
                <div class="form-group">
                      ...
                      <c:if test="${statuses != null}">
                        <c:forEach items="${statuses}" var="status">
                          <option value="${status.id}"
                            ${task.status.id == status.id ? 'selected' : ''}>${status.name}
                          </option>
                        </c:forEach>
                      </c:if>
                    </select>
